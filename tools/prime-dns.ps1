...
# This writes the same marked block that the HDT plugin (and the standalone app) maintain, so
# they will pick it up and keep it current. The plugin does this on its own; this script is for
# applying the fix without HDT, or undoing it.
#
# Run elevated:
